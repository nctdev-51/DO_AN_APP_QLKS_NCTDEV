-- ============================================================
-- HOTEL MANAGEMENT SYSTEM - MariaDB DATABASE MIGRATION
-- Converted from SQL Server T-SQL to MariaDB Standard SQL
-- ============================================================

-- 1. DROP EXISTING DATABASE (if exists) and CREATE NEW ONE
...
ALTER TABLE PhieuDatPhong
    ADD COLUMN trangThai VARCHAR(30) NOT NULL DEFAULT 'CHO_NHAN_PHONG'
        CHECK (trangThai IN ('CHO_NHAN_PHONG','DA_NHAN_PHONG','DA_TRA_PHONG','DA_HUY')),
ADD COLUMN maNhanVien CHAR(5) NULL,
ADD CONSTRAINT FK_PhieuDatPhong_NhanVien FOREIGN KEY (maNhanVien) REFERENCES NhanVien(maNhanVien);
